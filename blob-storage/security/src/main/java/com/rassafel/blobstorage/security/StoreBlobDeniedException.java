...
public class StoreBlobDeniedException extends StoreBlobException {
    ...
    public StoreBlobDeniedException(String message) {
        super(message);
    }

    public StoreBlobDeniedException(String message, Throwable cause) {
        super(message, cause);
    }

    public StoreBlobDeniedException(Throwable cause) {
        super(cause);
    }
}
